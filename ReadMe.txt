...
- MySql
	...
	- A new MySql user needs to be created in order to make the application connect to the MySql database. The credentials of the user can be requested from the project lead.
