...
namespace RentStuff.Property.Persistence.IntegrationTests
{
    ...
    class SearchResidentialPropertyTests
    {
        ...
        public void SearchMultipleHousesByCoordinates_ChecksIfNearbyHousesAreReturned_VerifiesByReturnValue()
        {
            ...
            // Save property for each property type multiple times, and search for each property type. The 
            // result should get the expected property type
            ...
            // Saving Property # 2: Near the search location, should be in the search results
            ...
            House house2 = new House.HouseBuilder().OwnerEmail(email2).OwnerPhoneNumber(phoneNumber2).Title(title2)
                .OwnerName(name2)
            ...
            string propertyType4 = Constants.House;
            ...
            House house4 = new House.HouseBuilder().OwnerEmail(email4).OwnerPhoneNumber(phoneNumber4)
                .Title(title4)
                .OwnerName(name4)
            ...
            // Saving House # 5: Should be in the search results
            ...
            string propertyType5 = Constants.House;
            ...
            House house5 = new House.HouseBuilder().OwnerEmail(email5).OwnerPhoneNumber(phoneNumber5)
                .Title(title5)
                .OwnerName(name5)
            ...
            House house6 = new House.HouseBuilder().Title(title6).OwnerEmail(email6)
                ...
                .Build();
            houseRepository.SaveorUpdate(house6);

            // Saving Property # 7: Outside bounds, should NOT be in the search results
            ...
            string propertyType7 = Constants.Apartment;
            ...
            House house7 = new House.HouseBuilder().OwnerEmail(email7).OwnerPhoneNumber(phoneNumber7).Title(title7)
                .OwnerName(name7)
                ...
                .Build();
            houseRepository.SaveorUpdate(house7);

            // Saving Property # 8: Outside bounds, should NOT be in the search results
            ...
            string propertyType8 = Constants.House;
            ...
            House house8 = new House.HouseBuilder().OwnerEmail(email8).OwnerPhoneNumber(phoneNumber8).Title(title8)
                .OwnerName(name8)
                ...
                .Build();
            houseRepository.SaveorUpdate(house8);

            // Saving Property # 9: Apartment. Outside bounds, should NOT be in the search results
            ...
            House house9 = new House.HouseBuilder().Title(title9).OwnerEmail(email9)
                ...
                .Build();
            houseRepository.SaveorUpdate(house9);

            // Saving Property # 10: Should be in the search results, again
            ...
            string propertyType10 = Constants.Apartment;
            ...
            House house10 = new House.HouseBuilder().OwnerEmail(email10).OwnerPhoneNumber(phoneNumber10)
                .Title(title10)
                .OwnerName(name10)
                ...
                .Build();
            houseRepository.SaveorUpdate(house10);
            ...
            Assert.AreEqual(6, retreivedHouses.Count);

            // The houses are retreived in random order, which means which house is going to be on which index. So we check 
            // that we are getting all the houses that we expecting by looping over them.
            House[] verificationHouses = new House[6]{house, house2, house3, house4, house5, house10};
            foreach (var retreivedHouse in retreivedHouses)
            {
                bool houseMatched = false;
                foreach (var verificationHouse in verificationHouses)
                {
                    if (verificationHouse.Id.Equals(retreivedHouse.Id) && verificationHouse.Title.Equals(retreivedHouse.Title) && verificationHouse.PropertyType.ToString().Equals(retreivedHouse.PropertyType.ToString()))
                    {
                        houseMatched = true;
                        break;
                    }
                }
                Assert.True(houseMatched);
            }
        }
