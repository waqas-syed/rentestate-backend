        ...
        public void SaveAndGetAllHousesTest_TestsThatHousesAreSavedAndRetreivedAsExpected_VerfiesThroughInstanceValue()
        {
            ...
            if (_runTests)
            {
                ...
                CreateHouseCommand house2 = new CreateHouseCommand(title2, rent2, numberOfBedrooms2, numberOfKitchens2,
                    ...
                    genderRestriction2, isShared2, rentUnit2, landlineNumber2, fax2);
                ...
                CreateHouseCommand house3 = new CreateHouseCommand(title3, rent3, numberOfBedrooms3, numberOfKitchens3,
                    ...
                    genderRestriction3, isShared3, rentUnit3, landlineNumber3, fax3);
                ...
                string area4 = "Nara, Punjab, Pakistan";
                ...
                bool isShared4 = true;
                string rentUnit4 = House.GetAllRentUnits()[0];
                ...
                CreateHouseCommand house4 = new CreateHouseCommand(title4, rent4, numberOfBedrooms4, numberOfKitchens4,
                    ...
                    genderRestriction4, isShared4, rentUnit4, landlineNumber4, fax4);
                ...
                bool isShared5 = true;
                string rentUnit5 = House.GetAllRentUnits()[1];
                string landlineNumber5 = "0510000005";
                string fax5 = "0510000005";
                ...
                CreateHouseCommand house5 = new CreateHouseCommand(title5, rent5, numberOfBedrooms5, numberOfKitchens5,
                    ...
                    genderRestriction5, isShared5, rentUnit5, landlineNumber5, fax5);
                ...
                Assert.AreEqual(isShared, retreivedHouses[0].IsShared);
                ...
                Assert.AreEqual(isShared2, retreivedHouses[1].IsShared);
