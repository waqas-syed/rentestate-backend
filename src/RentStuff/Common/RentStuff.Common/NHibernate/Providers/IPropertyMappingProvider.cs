...
{
    /// <summary>
    /// Interface specific to Property Bounded Context, so it can implement it and provide the NHibernate 
    ...
    {
        /// <summary>
        /// The implementation of this method adds the assemblies that contain mapping files of domain objects
        /// </summary>
